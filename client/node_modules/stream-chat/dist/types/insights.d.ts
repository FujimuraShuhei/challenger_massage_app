...
export declare function buildWsFatalInsight(connection: StableWSConnection, event: Record<string, unknown>): {
    ...
    user_details: import("stream-chat/dist/types/types").OwnUserResponse<import("stream-chat/dist/types/types").DefaultGenerics> | import("stream-chat/dist/types/types").UserResponse<import("stream-chat/dist/types/types").DefaultGenerics> | undefined;
    device: import("stream-chat/dist/types/types").BaseDeviceFields | undefined;
