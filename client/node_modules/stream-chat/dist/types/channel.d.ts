...
export declare class Channel<StreamChatGenerics extends ExtendableGenerics = DefaultGenerics> {
     ...
     */
    getConfig(): import("stream-chat/dist/types/types").ChannelConfigWithInfo<StreamChatGenerics> | undefined;
    /**
    ...
    sendFile(uri: string | NodeJS.ReadableStream | Buffer | File, name?: string, contentType?: string, user?: UserResponse<StreamChatGenerics>): Promise<import("stream-chat/dist/types/types").SendFileAPIResponse>;
    sendImage(uri: string | NodeJS.ReadableStream | File, name?: string, contentType?: string, user?: UserResponse<StreamChatGenerics>): Promise<import("stream-chat/dist/types/types").SendFileAPIResponse>;
