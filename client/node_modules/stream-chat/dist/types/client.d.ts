...
export declare class StreamChat<StreamChatGenerics extends ExtendableGenerics = DefaultGenerics> {
     ...
     */
    connectUser: (user: OwnUserResponse<StreamChatGenerics> | UserResponse<StreamChatGenerics>, userTokenOrProvider: TokenOrProvider) => Promise<void | import("stream-chat/dist/types/types").ConnectionOpen<StreamChatGenerics>>;
    /**
     ...
     * @return {ConnectAPIResponse<StreamChatGenerics>} Returns a promise that resolves when the connection is setup
     */
    setUser: (user: OwnUserResponse<StreamChatGenerics> | UserResponse<StreamChatGenerics>, userTokenOrProvider: TokenOrProvider) => Promise<void | import("stream-chat/dist/types/types").ConnectionOpen<StreamChatGenerics>>;
     ...
     */
    openConnection: () => Promise<void | import("stream-chat/dist/types/types").ConnectionOpen<StreamChatGenerics>>;
    /**
     ...
     */
    _setupConnection: () => Promise<void | import("stream-chat/dist/types/types").ConnectionOpen<StreamChatGenerics>>;
    /**
    ...
    */
     ...
     */
    connectAnonymousUser: () => Promise<void | import("stream-chat/dist/types/types").ConnectionOpen<StreamChatGenerics>>;
    /**
     * @deprecated Please use connectAnonymousUser. Its naming is more consistent with its functionality.
     */
    setAnonymousUser: () => Promise<void | import("stream-chat/dist/types/types").ConnectionOpen<StreamChatGenerics>>;
    /**
     ...
     * @return {ConnectAPIResponse<StreamChatGenerics>} Returns a promise that resolves when the connection is setup
     */
    setGuestUser(user: UserResponse<StreamChatGenerics>): Promise<void | import("stream-chat/dist/types/types").ConnectionOpen<StreamChatGenerics>>;
    /**
     ...
     * @private
     */
    connect(): Promise<void | import("stream-chat/dist/types/types").ConnectionOpen<StreamChatGenerics>>;
    /**
    ...
    translateMessage(messageId: string, language: string): Promise<APIResponse & StreamChatGenerics["messageType"] & {
        id: string;
        attachments?: import("stream-chat/dist/types/types").Attachment<StreamChatGenerics>[] | undefined;
        ...
        type: import("stream-chat/dist/types/types").MessageLabel;
        ...
        quoted_message?: import("stream-chat/dist/types/types").MessageResponseBase<StreamChatGenerics> | undefined;
    }>;
    /**
