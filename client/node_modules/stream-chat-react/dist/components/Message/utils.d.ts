...
import type { PinPermissions } from 'stream-chat-react/dist/components/Message/hooks';
import type { MessageProps } from 'stream-chat-react/dist/components/Message/types';
import type { MessageContextValue, StreamMessage } from 'stream-chat-react/dist/context';
...
export declare const areMessagePropsEqual: <StreamChatGenerics extends DefaultStreamChatGenerics = DefaultStreamChatGenerics>(prevProps: MessageProps<StreamChatGenerics, import("stream-chat-react/dist/types/types").CustomTrigger> & {
    mutes?: Mute<StreamChatGenerics>[] | undefined;
    showDetailedReactions?: boolean | undefined;
}, nextProps: MessageProps<StreamChatGenerics, import("stream-chat-react/dist/types/types").CustomTrigger> & {
    mutes?: Mute<StreamChatGenerics>[] | undefined;
    showDetailedReactions?: boolean | undefined;
}) => boolean;
